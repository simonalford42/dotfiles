...
alias vsgpu='srun --nodes=1 --gres=gpu:1 --cpus-per-task=4 --time=04:00:00 --mem=10G --partition=default_partition-interactive --pty bash'
alias vscpu='srun --nodes=1 --cpus-per-task=4 --time=04:00:00 --mem=10G --partition=default_partition-interactive --pty bash'
