...
before packages are loaded."
  ...
  ;; s and S go to beginning and end of line (not working? might conflict with evil's surround.vim)
  ;; (define-key evil-motion-state-map (kbd "S") 'evil-end-of-line)
  ;; (define-key evil-motion-state-map (kbd "s") 'evil-first-non-blank-of-line)
  ...
  (setq-default dotspacemacs-editing-style '(vim :variables
                                                 ;; if non-nil then objects are briefly highlighted
                                                 vim-style-visual-feedback t
                                                 ;; if non-nil Y is remapped to y$ in Evil states
                                                 vim-style-remap-Y-to-y$ t
                                                 ;; if non-nil, < and > retain visual state
                                                 vim-style-retain-visual-state-on-shift t
                                                 ;; if non-nil, J and K move lines up and down in visual mode
                                                 vim-style-visual-line-move-text t
                                                 ;; if non-nil, inverse meaning of g in :substitute Evil ex-command
